...
void register_convolution(nb::module_& module) {
    ...
    module.def(
           ...
           bool store_sorted) {
            return sparse_conv_features_sorted_implicit_gemm(
                ...
                SparseRelationContract{
                    array_arg(counts, "counts"), out_capacity, n_kernels
                },
        ...
        nb::sig(
            ...
            "row_offsets: mlx.core.array, in_row_offsets: mlx.core.array, "
            "in_edge_ids: mlx.core.array, kernel_row_offsets: mlx.core.array, "
            "kernel_edge_ids: mlx.core.array, "
