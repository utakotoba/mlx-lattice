...
template <typename T>
inline void sparse_relation_conv_weight_grad_tensor_ops_reduce_impl(
...
[[kernel]] void sparse_relation_conv_weight_grad_tensor_ops_reduce_f32(
    ...
    sparse_relation_conv_weight_grad_tensor_ops_reduce_impl<float>(
        partials,
        grad,
        n_kernels,
        partitions,
...
[[kernel]] void sparse_relation_conv_weight_grad_tensor_ops_reduce_f16(
    ...
    sparse_relation_conv_weight_grad_tensor_ops_reduce_impl<half>(
        partials,
        grad,
        n_kernels,
        partitions,
