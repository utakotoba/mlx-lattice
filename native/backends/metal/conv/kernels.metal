...
[[kernel]] void sparse_relation_conv_input_grad_f32_i32_cin16_dense_c16(
    ...
    dense_input_grad_cin16_impl<float, 16, 16>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f16_i32_cin16_dense_c16(
    ...
    dense_input_grad_cin16_impl<half, 16, 16>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
sparse_relation_conv_input_grad_f32_i32_cin16_dense_cin16_cout32(
    ...
    dense_input_grad_cin16_impl<float, 16, 32>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
sparse_relation_conv_input_grad_f16_i32_cin16_dense_cin16_cout32(
    ...
    dense_input_grad_cin16_impl<half, 16, 32>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f32_i32_cin4_dense_c32(
    ...
    dense_input_grad_cin4_impl<float, 32, 32>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f16_i32_cin4_dense_c32(
    ...
    dense_input_grad_cin4_impl<half, 32, 32>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f32_i32_cin4_dense_c64(
    ...
    dense_input_grad_cin4_impl<float, 64, 64>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f16_i32_cin4_dense_c64(
    ...
    dense_input_grad_cin4_impl<half, 64, 64>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f32_i32_cin16_dense_c32(
    device const float* cotangent [[buffer(0)]],
    device const float* weights [[buffer(1)]],
    device const int* in_rows [[buffer(2)]],
    device const int* out_rows [[buffer(3)]],
    ...
    dense_input_grad_cin16_grouped_impl<float, 32, 32>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f16_i32_cin16_dense_c32(
    device const half* cotangent [[buffer(0)]],
    device const half* weights [[buffer(1)]],
    device const int* in_rows [[buffer(2)]],
    device const int* out_rows [[buffer(3)]],
    ...
    dense_input_grad_cin16_grouped_impl<half, 32, 32>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_input_grad_f16_i32_cin16_dense_c64(
    device const half* cotangent [[buffer(0)]],
    device const half* weights [[buffer(1)]],
    device const int* in_rows [[buffer(2)]],
    device const int* out_rows [[buffer(3)]],
    ...
    dense_input_grad_cin16_grouped_impl<half, 64, 64>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
sparse_relation_conv_input_grad_f32_i32_cin16_dense_cin16_cout64(
    ...
    dense_input_grad_cin16_impl<float, 16, 64>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
sparse_relation_conv_input_grad_f16_i32_cin16_dense_cin16_cout64(
    ...
    dense_input_grad_cin16_impl<half, 16, 64>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
sparse_relation_conv_input_grad_f32_i32_cin16_dense_cin64_cout16(
    ...
    dense_input_grad_cin16_grouped_impl<float, 64, 16>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
sparse_relation_conv_input_grad_f16_i32_cin16_dense_cin64_cout16(
    ...
    dense_input_grad_cin16_grouped_impl<half, 64, 16>(
        cotangent,
        weights,
        out_rows,
        kernel_ids,
...
[[kernel]] void sparse_relation_conv_weight_grad_f32_i32_c4_dense_c16(
    ...
    dense_weight_grad_ci4_co4_impl<float, 16, 16>(
        feats,
        cotangent,
        in_rows,
        out_rows,
...
[[kernel]] void sparse_relation_conv_weight_grad_f16_i32_c4_dense_c16(
    ...
    threadgroup float partial[1024];
    dense_weight_grad_ci4_co4_impl<half, 16, 16>(
        feats,
        cotangent,
        in_rows,
        out_rows,
...
[[kernel]] void sparse_relation_conv_weight_grad_f32_i32_c4_dense_c32(
    ...
    threadgroup float partial[1024];
    dense_weight_grad_ci4_co4_impl<float, 32, 32>(
        feats,
        cotangent,
        in_rows,
        out_rows,
...
[[kernel]] void sparse_relation_conv_weight_grad_f16_i32_c4_dense_c32(
    ...
    threadgroup float partial[1024];
    dense_weight_grad_ci4_co4_impl<half, 32, 32>(
        feats,
        cotangent,
        in_rows,
        out_rows,
...
[[kernel]] void sparse_relation_conv_weight_grad_f32_i32_c4_dense_c64(
    ...
    threadgroup float partial[1024];
    dense_weight_grad_ci4_co4_impl<float, 64, 64>(
        feats,
        cotangent,
        in_rows,
        out_rows,
...
[[kernel]] void sparse_relation_conv_weight_grad_f16_i32_c4_dense_c64(
    ...
    threadgroup float partial[1024];
    dense_weight_grad_ci4_co4_impl<half, 64, 64>(
        feats,
        cotangent,
        in_rows,
        out_rows,
